...
\section{Seeken}
Als Seeken, eine deutsche Form des englischen Wortes für ,,Suchen'', wurde die Suche nach der ersten validen Schnittkonfiguration je Werkzeugumdrehung bezeichnet.
...
Seeken geschiet in der Seek-Schleife des FLussdiagrams in Abbildung \ref{fig:flowchart}.
...
Obwohl ein Kompromiss zwischen der Größe der Schrittweite beim Seeken und der dafür notwendigen Rechenzeit gefunden werden muss, kann die Schrittweite aggressiv gewählt werden.
