...
Die Abbildung \ref{fig:heightdistance} und \ref{fig:3dview} verdeutlichen das Vorgehen bei diesem iterativen Verfahren.
...
Das Resultat dieser Iteration sind in den Abbildungen \ref{fig:heightdistance} und \ref{fig:3dview} der ersten Punkte der dunkelroten Linien.
